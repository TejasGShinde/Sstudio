...
function AdminLogin({ setIsAuthenticated }) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-pink-500 to-red-300">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-pink-500 text-white font-semibold py-2 rounded-md hover:bg-blue-700">
            Login
          </button>
        </form>
        <p className="text-center text-sm mt-4 text-gray-500">
          This login is for authorized administrators only. User accounts are not permitted.
        </p>
      </div>
    </div>
  );
